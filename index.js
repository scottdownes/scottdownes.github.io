window.loadLeverJobs = function (options) {
  ...
  var url = 'https://api.lever.co/v0/postings/' + options.accountName + '?team=Engineering&team=Engineering%20-%20Agent&team=Engineering%20-%20Partner&group=team&mode=json';
